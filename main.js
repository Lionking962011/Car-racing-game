...
background_image = "https://media4.giphy.com/media/1lwlEzsDMsaxfdnjWV/giphy.gif";
...
function one()
{
    window.alert("Move Car 1 = up = up arrow key,  down = down arrow key, left = left arrow key , right = right arrow key and Move Car 2 = up = key w,  down = key s, left = key a, right =  key d")
}
